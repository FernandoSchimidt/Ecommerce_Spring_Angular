package com.fernandoschimidt.ecommerce.services.jwt;
...
public class UserDetailsServiceImpl implements UserDetailsService {
    ...
    public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {
        Optional<com.fernandoschimidt.ecommerce.entity.User> optionalUser = userRepository.findFirstByEmail(username);
